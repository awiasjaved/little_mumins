...
const Page = () => {
  const collections = [
    { age: "0-2", image: Day, alt: "" },
    { age: "3-5", image: Safa, alt: "" },
    { age: "6-8", image: Bismillah, alt: "" },
    { age: "9-12", image: Bismillah, alt: "" },
    { age: "13-16", image: Bismillah, alt: "" },
    { age: "16+", image: Bismillah, alt: "" },
  ];
  ...
  useEffect(() => {
    ...
    controls.start({
      x: [0, -scrollWidth / 2], // only scroll half of the duplicated items
      transition: {
        duration: 10,
        ease: "linear",
        repeat: Infinity,
  ...
  return (
    <div className="mx-auto px-4 py-8">
      ...
      <div className="relative overflow-hidden" ref={scrollRef}>
        <motion.div
          animate={controls}
          className="flex gap-6 px-10 py-4"
        >
          {repeatedCollections.map((collection, index) => (
            <div key={index} className="flex-shrink-0 w-64">
              <div className="flex flex-col items-center">
                <div className="rounded-full border-4 border-lime-400 p-1 mb-3 overflow-hidden w-48 h-48 mx-auto">
                  <img
